...
`).insertBefore('div#d2bc'),$(`<img src ="sico/z1c7j29n8e10.gif" etclass="fr" style="width:100%;margin-top: 1px;">
...
div#tlogins .hand.nosel.fl.uzr.border,.lonline.light.break
{
...
.asim11
{
	background-image:url(https://iqr30.com/sico/z1c83boo5b10.jpg)
}
...
.btn-sm,.btn-sm
{
	...
	border-radius:10px 10px 10px 10px;
	width:100%;
	background-image:url(https://iqr30.com/sico/z1c77cd09a10.gif)
}
...
.fl.fa.fa-sign-in.b.fa.fa-send.fl.btn.btn-primary,.label.label-primary,.minix.badge.border,.ae.fa.label.fa-commenting-o.label-warning,.fa.fa-send.fl.btn.btn-primary,.fa.fa-sign-out.fl.btn.btn-primary
{
