...
fa.fa-user {border-radius: 10px 10px 10px 10px;}
ul.nav.nav-tabs.fl li a {font-family: 'jazeera',FontAwesome;font-size: 13px!important;padding: 4px!important;text-align: center!important;border-radius: 5px 5px 0px 0px;width: 100%;color: #bd4b87;}
.well {font-family: 'jazeera',FontAwesome;font-size: 16px!important;padding: 3px!important;text-align: center!important;width: 100%;color: #C4475C;white-space: nowrap;}
...
div#l3 button, div#l1 button {background-color: #cc2965!important; border: 1px solid #ba3c66;  font-family: 'jazeera',FontAwesome; border: 1px solid #FFE0F6; class: asim11;border-radius: 30px 30px 30px 30px;}
div#l2 button {background-color: #cc2965!important; border: 1px solid #ba3c66;  font-family: 'jazeera',FontAwesome; border: 1px solid #FFE0F6; class: asim11;border-radius: 30px 30px 30px 30px;}
#collapseExample {font-family: 'jazeera',FontAwesome;font-size: 13px!important;padding: 3px!important;text-align: center!important;width: 100%;background-image: url(https://iqr30.com/sico/z1c77cd09a10.gif);
...
.bgg.border.corner.w1c8tmld5910.active {border: 1px solid #C4C0C0}
.label-primary, .btn-primary {border: 1px solid #C4C0C0;border-radius: 30px 30px 0px 30px;class: asim11;}
